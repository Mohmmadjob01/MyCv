...
namespace MyCv.Areas.Admin.Controllers
{
    ...
    public class AboutsController : Controller
    {
        ...
        public AboutsController(CvDb context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Abouts != null ? 
                          ...
                          Problem("Entity set 'CvDb.Abouts'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("AboutId,AboutDec,Skills")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AboutId,AboutDec,Skills")] About about)
        {
            if (id != about.AboutId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CvDb.Abouts'  is null.");
            }
            var about = await _context.Abouts.FindAsync(id);
            if (about != null)
            {
